(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (py-autopep8 elpy irfc treemacs helm-tramp gore-mode gorepl-mode go-imports go-guru go-eldoc go-autocomplete ein diff-hl inform-mode malyon tldr projectile-speedbar ac-emmet markdown-mode+ markdown-mode esh-help drag-stuff ac-js2 tern-auto-complete ac-emacs-eclim eclim flymake-css flymake-sass tagedit flymake-jslint flycheck-demjsonlint edbi flycheck-plantuml git-wip-timemachine bury-successful-compilation flymake-ruby robe flycheck-yamllint yaml-mode npm-mode helm-org-rifle js2-refactor plantuml-mode nginx-mode ox-reveal org-ac muttrc-mode js2-highlight-vars js2-mode nodejs-repl expand-region autodisass-java-bytecode javarun multiple-cursors ess foreign-regexp clips-mode ecb ac-geiser geiser bookmark+ ac-slime auto-complete rainbow-blocks rainbow-delimiters smart-mode-line-powerline-theme smart-mode-line eshell-fringe-status eshell-prompt-extras helm-sage sr-speedbar visual-regexp web-beautify help-mode+ help-fns+ help+ magit eldoc-extension css-eldoc ibuffer-tramp ibuffer-vc ibuffer-projectile ibuffer-git gopher auctex tern exec-path-from-shell dired+ helm-swoop helm-projectile helm-package helm-orgcard helm-make helm-ls-git helm-fuzzier helm-flymake helm-flycheck helm-emmet helm-css-scss helm-ag helm tabbar golden-ratio-scroll-screen golden-ratio org-bullets leuven-theme info+)))
